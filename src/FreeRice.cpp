...
void extractGame() {
    ...
    cout << "questionword: " << questionWord << "!!" << endl;
...
if (token.empty()) {
    ...
    if (userId.empty()) {
        ...
        string rice = extractString(json, "\"rice\":", ",");

        cout << "We have made " << rice << " rice!!" << endl;
        ...
        map<string, float> answerSimilarities = getSimilarities(nlp_model, questionWord, answers);
        string maxKey;
